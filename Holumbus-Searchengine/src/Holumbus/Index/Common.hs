...
class HolDocuments d a where
  ...
  -- For index implementations, where the DocIds are generated by counter variable,
  -- the DocIds can be made disjoint by adding maxDocId
  -- of one to the DocIds of the second, e.g. with editDocIds
