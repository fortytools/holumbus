...
{- |
  ...
  Main program to use as FastCGI application for serving Hayoo!
...
loadIndex :: FilePath -> IO InvertedOSerialized
...
main = do
  ...
  runFastCGIConcurrent numThreads $ app
