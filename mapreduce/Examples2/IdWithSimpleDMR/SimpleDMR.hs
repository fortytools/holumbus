...
-}
-- ----------------------------------------------------------------------------
module Examples2.IdWithSimpleDMR.SimpleDMR 
(
   SimpleMapFunction
...
actionConfig m r = {-# SCC "actionConfig3" #-}(defaultActionConfiguration "ID") {
           ac_Map     = {-# SCC "actionConfig1" #-}Just . defaultMapConfiguration    $ simpleMapping m
         , ac_Reduce  = {-# SCC "actionConfig2" #-}Just . defaultReduceConfiguration $ simpleReduce r
         }
